...
public class Main {
    public static void main(String[] args) {
        ...
        manager.addStudent(new Student(101, "An", "IT", 3.8));
        manager.addStudent(new Student(102, "Bình", "Business", 3.5));
        manager.addStudent(new Student(103, "Cường", "IT", 3.9));
        manager.addStudent(new Student(104, "Dũng", "Economics", 2.8));
